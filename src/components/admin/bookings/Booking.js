      ...
      <ul className="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800" role="tablist">
        <li className="me-2">
          <button
            ...
            aria-selected={activeTab === "boooking"}
            className={`inline-block p-4 ${activeTab === "booking" ? "text-blue-600 rounded-ss-lg dark:text-blue-500" : "hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700"}`}
          >
            All Bookings
          </button>
        </li>
